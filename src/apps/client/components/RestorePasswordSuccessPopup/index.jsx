...
const RestorePasswordSuccess = ({ theme }) => {
    const dispatch = useDispatch();
    const intl = useIntl();

    const handleClosePopup = () => {
        dispatch(setRestorePasswordSuccessPopup(false));
    };
            ...
            <ClickAwayListener onClickAway={handleClosePopup}>
                <div className={styles.body}>
                    <div className={styles.wrapper}>
                        <div className={styles.title}>{intl.formatMessage({ id: 'form.restorePasswordSuccessTitle' })}</div>
