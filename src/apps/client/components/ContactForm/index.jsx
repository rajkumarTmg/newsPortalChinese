...
import contact from '../../services/client/contact';
// STYLES
        ...
        <div className={classNames(styles.root, {
            ...
            <ClickAwayListener onClickAway={handleClosePopup}>
                <div className={styles.body}>
                    <div className={styles.title}>{intl.formatMessage({ id: 'form.contactTitle' })}</div>
                    <div className={styles.subtitle}>{intl.formatMessage({ id: 'form.contactSubtitle' })}</div>
